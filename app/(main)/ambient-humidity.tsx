...
export default function AmbientHumidity() {
  ...
  useEffect(() => {
    setcurrentValue(sensorData.ambientHumidity);
  }, [sensorData]);
  const unit = "%";
  const weeklyData = [62, 64, 65, 67, 66, 64, 63];
      ...
      >
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={[styles.statValue, { color: "#FF9800" }]}>67%</Text>
          </View>
          <View style={styles.statItem}>
            <Text
              style={[styles.statLabel, { color: theme.colors.textSecondary }]}
            ...
            <Text style={[styles.statValue, { color: "#2196F3" }]}>62%</Text>
          </View>
        </View>
      </View>
