// app/(main)/add_device.jsx — Step-wise form wizard (Method → Details → Connect)
...
export default function AddDevice() {
  ...
  const beginConnect = async (name, type, externalKey) => {
    ...
    try {
      await createThing(name, type, externalKey);
      // ✅ Navigation to device selection happens inside createThing
    } catch (error) {
  ...
  const renderStepIndicator = () => (
    <View style={styles.progressWrap}>
      ...
      <Text style={[styles.stepLabel, { color: theme.colors.textSecondary }]}>
        Step {step} of 3 · {step === 1 ? "Choose method" : step === 2 ? "Enter details" : "Connecting"}
      </Text>
    </View>
  );
        ...
        {step === 1 && (
          ...
          >
            ...
            <Text style={[styles.subtitle, { color: theme.colors.textSecondary }]}>
              Link another AgriArch sensor device so your farm keeps reporting
              in real time. Choose how you'd like to connect.
            </Text>
            ...
            >
              ...
              >
                <Ionicons
                  name="cube-outline"
                  size={18}
                  color={focusedField === "name" ? primary : theme.colors.textSecondary}
                />
                <TextInput
              ...
              >
                <Ionicons
                  name="key-outline"
                  size={18}
                  color={focusedField === "key" ? primary : theme.colors.textSecondary}
                />
                <TextInput
              ...
              >
                <Ionicons
                  ...
                  size={18}
                  color={focusedField === "type" ? primary : theme.colors.textSecondary}
                />
                <TextInput
